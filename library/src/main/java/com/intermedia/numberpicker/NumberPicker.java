...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mColors = mInputText.getTextColors();
        int color = mColors.getColorForState(ENABLED_STATE_SET, Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if(selectorIndex == getValue()) {
                mSelectorWheelPaint.setColor(mColors.getColorForState(SELECTED_STATE_SET, Color.BLACK));
            } else {
                mSelectorWheelPaint.setColor(mColors.getColorForState(EMPTY_STATE_SET, Color.BLACK));
            }
